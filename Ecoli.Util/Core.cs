namespace Ecoli.Util
{
    ...
    public class Core
    {
        ...
        public static string Dir = ConfigurationManager.AppSettings["modelOutput"];
        ...
        public static void SaveAsDgs(HyperGraph.Node mi, HyperGraph graph, string dir)
        {
            ...
            // todo draw cycle to metabolite edges with fluxes
            //foreach (var cycle in graph.Cycles.Values)
            //{
            //    cycle
            //}
