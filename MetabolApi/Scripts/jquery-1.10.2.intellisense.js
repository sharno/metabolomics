...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given userkey attribute.</summary>
    ///   <param name="userkey" type="String">An ID to search for, specified via the userkey attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
