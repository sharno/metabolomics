...
{
    [Serializable(), SoapType("SoapStoichiometryMath")]
    public class SoapStoichiometryMath : SoapSbase
    {
        ...
        public SoapStoichiometryMath(string metaId, string sboTerm, string notes, string annotation, string math)
