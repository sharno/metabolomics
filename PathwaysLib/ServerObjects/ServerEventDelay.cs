...
namespace PathwaysLib.ServerObjects
{
    ...
    public class ServerEventDelay : ServerSbase
    {

        #region Constructor, Destructor, ToString
        private ServerEventDelay()
        {
        }
        ...
        /// </remarks>
        public ServerEventDelay(SoapEventDelay data)
            : base((SoapSbase)data)
        {
            switch (data.Status)
            {
                case ObjectStatus.Insert:
                    ...
                    __EventDelayRow = new DBRow(__TableName);
                    break;
                ...
                case ObjectStatus.NoChanges:
                    ...
                    __EventDelayRow = LoadRow(data.ID);
                    break;
                default:
        ...
        /// </param>
        public ServerEventDelay(DBRow data)
            : base(ServerSbase.LoadRow(data.GetGuid("id")))
        {
            // setup object
            __EventDelayRow = data;

        }


        public ServerEventDelay(DBRow eventDelayRow, DBRow sbaseRow)
            : base(sbaseRow)
        {
            // setup object
            __EventDelayRow = eventDelayRow;
        }
        ...
        private static readonly string __TableName = "EventDelay";
        protected DBRow __EventDelayRow;
        #endregion
        ...
        public override Guid ID
        {
            get
            {
                return __EventDelayRow.GetGuid("id");
            }
            set
            {
                base.ID = value;
                __EventDelayRow.SetGuid("id", value);
            }
        }
        ...
        public string Math
        {
            get
            {
                return __EventDelayRow.GetString("math");
            }
            set
            {
                __EventDelayRow.SetString("math", value);
            }
        }
        ...
        {
            base.UpdateDatabase();
            __EventDelayRow.UpdateDatabase();
        }
        /// <summary>
        ...
        {
            SoapEventDelay retval = (derived == null) ?
                retval = new SoapEventDelay() : retval = (SoapEventDelay)derived;
        ...
        {
            SoapEventDelay c = o as SoapEventDelay;
        ...
        protected override void SetSqlCommandParameters()
        {
            ...
            __EventDelayRow.ADOCommands["insert"] = DBWrapper.BuildCommand(
                "INSERT INTO " + __TableName + " (id, math) VALUES (@id, @math);",
                "@id", SqlDbType.UniqueIdentifier, ID,
                "@math", SqlDbType.Xml, Math);

            __EventDelayRow.ADOCommands["select"] = DBWrapper.BuildCommand(
                "SELECT * FROM " + __TableName + " WHERE id = @id;",
                "@id", SqlDbType.UniqueIdentifier, ID);

            __EventDelayRow.ADOCommands["update"] = DBWrapper.BuildCommand(
                "UPDATE " + __TableName + " SET math = @math where id = @id ;",
                "@math", SqlDbType.Xml, Math,
                "@id", SqlDbType.UniqueIdentifier, ID);

            __EventDelayRow.ADOCommands["delete"] = DBWrapper.BuildCommand(
        ...
        /// </returns>
        public static ServerEventDelay[] AllEventTriggers()
        {
            ...
            {
                results.Add(new ServerEventDelay(new DBRow(d)));
            }

            return (ServerEventDelay[])results.ToArray(typeof(ServerEventDelay));
        }
        ...
        /// </returns>
        public static ServerEventDelay Load(Guid id)
        {
            return new ServerEventDelay(LoadRow(id));
        }
