...
{		
	...
	/// </remarks>
	#endregion
	public abstract class ServerMolecularEntity : ServerObject, IGraphMolecularEntity
	{
		...
		/// Constructor
		/// </summary>
		protected ServerMolecularEntity ( )
		{
		}
...
//        }
		...
		/// </param>
		/// <param name="type"></param>
		protected ServerMolecularEntity ( SoapMolecularEntity data, string type )
		{
		...
		/// </param>
		protected ServerMolecularEntity ( DBRow data )
		{
            // (mfs)
            // setup object
            __DBRow = data;
...
/*------------------------------- Change Log -----------------------------
	$Id: ServerMolecularEntity.cs,v 1.5 2009/05/27 14:35:49 ali Exp $
	$Log: ServerMolecularEntity.cs,v $
