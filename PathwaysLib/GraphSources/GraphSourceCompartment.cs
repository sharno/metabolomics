...
namespace PathwaysLib.GraphSources
{
	...
	/// </summary>
	public class GraphSourceCompartment : IGraphSource
	{
        ...
        private Guid[] sExpandedPathways=new Guid[1];
		...
		/// Default constructor
		/// </summary>
		public GraphSourceCompartment( Guid modelid, string type )
		{
            Model = ServerModel.LoadP(modelid);
			...
			graphType = type;
            sExpandedPathways[0] = new Guid("ae768ec9-10cc-4193-bd4d-6d595dd3ddab");
            //Initialize();
        }
/*
        public GraphSourceCompartment(Guid modelid, string type, Guid processid, string processname)
        {
...
*/
        ...
        public GraphLayout Layout
		{
            ...
            get { return GraphLayout.Organic;}// .Hierarchical; }
		}
		...
		{
            get { return "Compartment Visualization"; }
		}
        ...
        Guid[] IGraphSource.CollapsedPathways
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return null; }
        }

        Guid[] IGraphSource.ExpandedPathways
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return sExpandedPathways; }
        }

        Guid[] IGraphSource.GenericProcessGraphIDs
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return null; }
        }

        Guid[] IGraphSource.MoleculeGraphIDs
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return null; }
        }

        GraphLayout IGraphSource.Layout
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return GraphLayout.Organic; }
        }

        Guid IGraphSource.SourceNode
        {
            //get { throw new Exception("The method or operation is not implemented."); }
        ...
        string IGraphSource.InitialOrganism
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return string.Empty; }
        }

        string IGraphSource.GraphType
        {
            //get { throw new Exception("The method or operation is not implemented."); }
        ...
        string IGraphSource.GraphTitle
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return "Compartment Visualization"; }
        ...
        GraphColoring[] IGraphSource.Colorings
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return null; }
        }

        bool IGraphSource.LegendVisible
        {
            //get { throw new Exception("The method or operation is not implemented."); }
            get { return false; }
        }
