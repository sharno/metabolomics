...
namespace PathwaysLib.Exceptions
{
    ...
    public class PathwayException : Exception 
    {
        ...
        public PathwayException(string message) : base(message)
        {
        }
        ...
        public PathwayException(string messageFormat, params object[] args) : base(string.Format(messageFormat, args))
        {
        }
        ...
        public PathwayException(string message, Exception innerException) : base(message, innerException)
        {
        }
...
/*------------------------------- Change Log -----------------------------
	$Id: PathwayException.cs,v 1.1 2008/05/16 21:15:53 mustafa Exp $
	$Log: PathwayException.cs,v $
