...
namespace PathwaysLib.Exceptions
{
    ...
    /// </summary>
    #endregion    
    public class DBWrapperException : PathwayException 
    {
        ...
        /// </summary>
        public DBWrapperException() : base()
        {
        }
        ...
        public DBWrapperException(string messageFormat, params object[] args) : base(messageFormat, args)
        {
        }
        ...
        public DBWrapperException(string message, Exception innerException) : base(message, innerException)
        {
        }
...
/*------------------------------- Change Log -----------------------------
	$Id: DBWrapperException.cs,v 1.1 2008/05/16 21:15:53 mustafa Exp $
	$Log: DBWrapperException.cs,v $
	...
	*** empty log message ***
	...
	Revision 1.1  2005/06/15 19:51:12  brendan
	Added DBWrapper and QueryTimeout exceptions for use by DBWrapper.
