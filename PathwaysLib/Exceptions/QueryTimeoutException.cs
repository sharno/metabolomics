...
namespace PathwaysLib.Exceptions
{
    ...
    /// </summary>
    #endregion    
    public class QueryTimeoutException : DBWrapperException 
    {
        ...
        public QueryTimeoutException(string messageFormat, params object[] args) : base(messageFormat, args)
        {
        }
...
/*------------------------------- Change Log -----------------------------
	$Id: QueryTimeoutException.cs,v 1.1 2008/05/16 21:15:53 mustafa Exp $
	$Log: QueryTimeoutException.cs,v $
