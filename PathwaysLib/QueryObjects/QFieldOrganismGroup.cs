...
{
	/// <summary>
	/// A query field for organism groups
	/// </summary>
    ...
    public class QFieldOrganismGroup : QField
	{
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="initValue">The initial value; use string.Empty for none</param>
		public QFieldOrganismGroup( string initValue ) : base( initValue ) {}

		public override string SelectSQL
        {
            get { return "OG{0}.common_name AS [Organism # Group]"; }
        }
        ...
        //{
        //    return new string[] { "(OG{0}.common_name LIKE " + DBWrapper.PreprocessSqlArgValue("%" + val + "%") + " OR OG{0}.scientific_name LIKE " + DBWrapper.PreprocessSqlArgValue("%" + val + "%") + ")" };
        //}
