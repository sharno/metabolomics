...
{
    [QNodeType("path_to_molecule")]
    public class QNodePathToMolecule : QNode
    {
        private QNodePathToMolecule()
        { }

        public QNodePathToMolecule(QNode parent)
            : base("path_to_molecule", "Molecule", parent, null, null, new QNodeBasicRenderer(), new QFieldBasicRenderer())
        {
