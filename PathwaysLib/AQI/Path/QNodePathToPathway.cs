...
{
    [QNodeType("path_to_pathway")]
    public class QNodePathToPathway : QNode
    {
        private QNodePathToPathway()
        { }

        public QNodePathToPathway(QNode parent)
            : base("path_to_pathway", "Pathway", parent, null, null, new QNodeBasicRenderer(), new QFieldBasicRenderer())
        {
