namespace Ecoli
{
    ...
    public class Fba3
    {
        ...
        public Dictionary<string, double> BlockedReactions = new Dictionary<string, double>();
            ...
            foreach (var reaction in sm.Edges)
            {
                ...
                if (reaction.Value.UpdatePseudo.Count != 0)
                {
                    ...
                    if (isProducer)
                    {
                        ...
                        exchangeStoch = Db.InvolvedReactionCount(meta.Key).Producers;
                        uc =
                    ...
                    else
                    {
                        ...
                        exchangeStoch = Db.InvolvedReactionCount(meta.Key).Consumers;
                        uc =
