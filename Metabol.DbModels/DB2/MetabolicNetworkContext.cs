...
{
    public partial class MetabolicNetworkContext : DbContext
    {
        public MetabolicNetworkContext(): base("name=MetabolicNetworkContext")
        {
        }
        ...
        public virtual DbSet<FixedReactions> FixedReactions { get; set; }
