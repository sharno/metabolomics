...
namespace PathwaysLib.AQI
{
    ...
    public class QNodeMolecule : QNode
    {
            ...
            : base("molecule", "Molecular Entity", parent, new SqlDatasetQuerier(PathwaysAQIUtil.Instance), new SqlDatasetRenderer(PathwaysAQIUtil.Instance), new QNodeBasicRenderer(), new QFieldBasicRenderer())
        {
            ...
            // sort order within "Add new:..." UI
            //r.AddLinkSortOrder = 3; 

            // relationship with the Root
            //r.AddRelationship("", "Molecular Entity", "Search for a molecule"); // info text for this node at the root           
            ...
            //r.AddRelationship("pathway", "Molecular Entity", "A molecular entity that takes place in a process in this pathway");
            ...
            //r.AddRelationship("process", "Molecular Entity", "A molecular entity involved in this process");
            ...
            //r.AddRelationship("organism", "Molecular Entity", "A molecular entity involved in a process that takes place in this organism");
